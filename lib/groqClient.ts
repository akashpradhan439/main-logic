...
const SYSTEM_PROMPT = `You are a connection suggestion assistant for a location-based privacy-focused social app.
...
const INTERESTS_SYSTEM_PROMPT = `You are a helpful assistant for a social app.
...
export async function suggestInterests(bio: string): Promise<string[]> {
  ...
  try {
    const completion = await groq.chat.completions.create({
      ...
      messages: [
        { role: "system", content: INTERESTS_SYSTEM_PROMPT },
